...
## Obiettivo
far collaborare agenti su una mini feature.

## Durata
25-35 minuti.

## Prerequisiti
- Branch `lab/lab03_feature_workflow`.
...
## Prompt suggerito
```text
Lavora come workflow-orchestrator. Usa gli agenti minimi necessari per far collaborare agenti su una mini feature. Prima proponi piano e rischi, poi procedi con modifiche piccole e verificabili. Non leggere file segreti e non fare push.
```
