...
## Obiettivo
bloccare comandi/file rischiosi e generare audit log.

## Durata
25-35 minuti.

## Prerequisiti
- Branch `lab/lab02_security_hooks`.
...
## Prompt suggerito
```text
Lavora come workflow-orchestrator. Usa gli agenti minimi necessari per bloccare comandi/file rischiosi e generare audit log. Prima proponi piano e rischi, poi procedi con modifiche piccole e verificabili. Non leggere file segreti e non fare push.
```
