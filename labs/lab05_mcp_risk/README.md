...
## Obiettivo
valutare un server MCP prima di autorizzarlo.
...
## Prompt suggerito
```text
Lavora come workflow-orchestrator. Usa gli agenti minimi necessari per valutare un server MCP prima di autorizzarlo. Prima proponi piano e rischi, poi procedi con modifiche piccole e verificabili. Non leggere file segreti e non fare push.
```
